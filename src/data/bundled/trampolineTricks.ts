...
// Bundled Trampoline library — offline / first-launch fallback.
// The live library is pulled from the Trampoline tab of the Google Sheet.
export const TRAMPOLINE_TRICKS: Trick[] = [
